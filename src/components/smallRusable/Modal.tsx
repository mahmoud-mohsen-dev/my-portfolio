...
export default function VerticalyCentered({
  cvURl,
  showModal,
  setShowModal,
}: {
  ...
  return (
    ...
    <TEModal show={showModal} setShowModal={setShowModal} scrollable className="">
        ...
        <TEModalContent className="">
          ...
          <TEModalBody className="">
            ...
            <p className=" px-2 pb-5 text-lg font-semibold">
              Fast-forward to today, and here I am, still learning something new every day as I look for new challenges
